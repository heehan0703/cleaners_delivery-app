...
$want_to_pickup=$_POST['want_to_pickup'];
...
if(z=="")
{
	alert("Please enter expiration_date");
return false;
...
<form action="agreement.php" method="post" name="myform" id="myform" style="width:100%" >
  ...
  <p>
    ...
    <input class="input" type="text" name="card_number" id="card_number" size="30%" placeholder="16-digit Without Space">
  </p>
  ...
  Expiration Date (MM/YY)                                      
    ...
    <br>
    <input  class="input" name="expiration_date" id="expiration_date" type="text" value="" placeholder="ex) 10/17" style="width: 107px;"> </div>
    <div style="float:left; margin-left: 38.2px; width: 100px;">CVV<br>
    <input  class="input" name="cgv" id="cgv" type="text" value="" style="width: 91.4px;" placeholder="3 Digit on Back Side"></div>
