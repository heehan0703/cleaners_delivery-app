...
<?php if($result['want_to_pickup']==$result['want_to_pickup']) {?> selected="selected"<?php }?> ><?=$result['want_to_pickup']?></option>
    ...
    <div class="form-group">
     ...
     <div class="form-group">
      ...
      <div class="col-xs-8">          
        <input type="text" class="form-control" id="cgv" name="expiration_date" value="<?= $result['cgv'] ?>">
      </div>
    </div>
    ...
    <option <?php if($result['payment_later']== 'yes') {?> selected="selected" <?php } ?>>YES</option>
    <option <?php if($result['payment_later']!= 'yes') {?> selected="selected" <?php } ?>>NO</option>
    </select>
    </div>
    </div>
