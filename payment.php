...
var d=document.getElementById('cgv').value;
if(y=="")
{
	alert("Please enter card User name");
return false;
}
...
if(z.search(expiration4digit)==-1)
{
	alert("Please enter valid 4 digit expiration date");
return false;
	
}
if(d.search(cgv3digit)==-1)
{
	alert("Please 3  enter valid 3 digit cgv");
return false;
...
if(d.search(cgv3digit)==-1)
{
	alert("Please enter valid 3 digit cgv");
return false;
...
<form action="agreement.php" method="post" name="myform" id="myform" style="width:100%" >
    ...
    <div  style=" width:90%;background-color:#486DB5; line-height:30px; margin-left:14px; margin-right:10px;">
     ...
     <p>Bluehangers Will Follow Up Your Every Order With A Detailed
Statement From Our Professional Royal Company's
Dry Cleaners Invoice System.</p>
  ...
  <p>
    ...
    <input class="input" type="text" name="card_name" placeholder="Full Name" id="card_name" size="30%">
  </p>
  <p>
    <label for="cn">Card Number(Please enter your 16-digit  credit card number!)<br>
    </label> 
    <input class="input" type="text" name="card_number" placeholder="16-digit number" id="card_number"size="30%">
  </p>
  ...
  Expiration Date(MMYY)                                      
    ...
    <br>
    <input  class="input" name="expiration_date" id="expiration_date" type="text" value="" placeholder="1017" style="width: 107px;"> </div>
    <div style="float:left; margin-left: 38.2px; width: 100px;">CVV<br>
    <input  class="input" name="cgv" id="cgv" type="text" value="" placeholder="3 Digit(back)" style="width: 91.4px;"></div>
  ...
  <p>&nbsp;    </p>
  <p>&nbsp;</p>
  <p style="margin-top: 22.8px;">You will be charged only when  your order has been successfully delivered.<br>
    
   <br />
  <input  type="checkbox"  id="billlater" name="bill" value="yes" >Bill Me Later</p>
  <p class="mar">
  <input type="button" name="previous"  value="PREVIOUS" id="previous">
  <input type="button" name="NEXT"  value="NEXT" id="next" onClick="validate_creditcardnumber()"></p>
  </form>
</div>
</body>
</html>