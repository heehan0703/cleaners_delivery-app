...
$date=date("D-M-d");
$date1=date("D, M d ",strtotime(' +2 day'));
...
<input type="radio" class="css-checkbox" name="RadioGroup2" value="radio" id="hem" <? if($page_row[25]=='default'){ ?> checked="checked" <? } ?>   >
    ...
    <br> <br>
   <input type="radio" class="css-checkbox" name="RadioGroup2" value="radio" id="button" <? if($page_row[25]=='nextday'){ ?> checked="checked" <? } ?>  >
  ...
  <br> <br>
  <input type="radio" class="css-checkbox" name="RadioGroup2" value="radio" id="sew"  <? if($page_row[25]=='sameday'){ ?> checked="checked" <? } ?> >
...
<div class="row" style="margin-top: 5%; margin-bottom: 2%;">        
      <div class="col-xs-12" align="center";>
        <button type="submit" name="submit" class="btn btn-default" style="width:100%;height:50px; background:#486DB5; color:#FFF;">UPADATE MY ORDER</button>
