...
$page_row=mysql_fetch_row(mysql_query("SELECT * FROM `pages` where id=4"));
...
<body>
    ...
    <form style="" onSubmit="return validation()" action=""  method="post">
      <div  style=" width:90%;background-color:#486DB5; line-height:30px; margin-left:14px; margin-right:10px;">
        <div style="vertical-align:middle; font-family: myFirstFont; text-align:center; color:#FFF; float:left; width:90%;">BLUEHANGERS.ORG</div>
        <div style="float:left;"><a href="home.php" style="text-decoration:none;"><img src="images/home2.png" alt=""></a></div>
        <div style="clear:both;"></div>
      </div>
      <p style="margin-top: 20.7px; color:24aae1; font-weight:bold; font-size:24px; font-family:Verdana, Geneva, sans-serif;"> 
      ...
      <div style="margin-top:20px; text-align:center; margin:auto;">
