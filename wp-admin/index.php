...
$_SESSION['COUNT']=$count;
$result=$_SESSION['COUNT'];
header("location: http://test.edoum.com/wp-admin/admin_menu.php?count=1");
?>
<script type="text/javascript">
//window.location="http://test.edoum.com/wp-admin/admin_menu.php";
</script>
...
<div class="col-xs-8 col-sm-8"><h3 style="color: #FFF;">ADMIN LOGIN</h3></div>
</div>
