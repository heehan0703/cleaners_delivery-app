...
<form style=" border:1px solid black;" action="" method="post" enctype="multipart/form-data" >
 ...
 <div style="width:100%;">
  ...
  <div style="width:50%; float:left; margin-left:2%;"> <font color="#9F9E9A" style=" font-size:24px;">Dry Cleaning  Laundry</font> </div>
 ...
 <div style="width:100%;">
  ...
  <div style="width:50%; float:left; margin-left:2%;"><font color="#9F9E9A"> <h4>Households</h4> </font> </div>
  <div style="text-align:right; margin-right:6px;"> <label class="myCheckbox">
  ...
  <div class="row">
  <div class="col-xs-12" style=" margin-left:2%;"> <font color="#9F9E9A" ><h4>Alterlation</h4></font></div>
  </div>
 ...
 <label class="myCheckbox">
  ...
  <div class="row">
  <div class="col-xs-12" style=" margin-left:2%;"><font color="#9F9E9A" ><h4>Memo</h4></font></div>
  </div>
...
$day=date("D ",strtotime($orderdat));
$month=date("M",strtotime($orderdat));
$date=date("d ",strtotime($orderdat));
?>
...
<? }elseif($num==0) { ?>
<p style="margin-top:24px; text-align:center; font-size:30px"><b>Your Order is empty </b></p>
...
<? }else{ ?>
    ...
    <form style="border:1px solid black;" onSubmit="return validation()" action=""  method="post">
	  ...
	  <P style="text-align:center;" align="center"> <center>  <h1 style="margin-top: 0px;">
      <b style="color:#00aced; margin-left: 10.1px;">MY ORDER </b></h1> </center> </P>
    ...
    <div style="width:27%; float:left; text-align: center;">Price</div>
      ...
      <a href="myorder_edit?id=<?=$row['id']?>" style="text-decoration:none; background:#000;"  >
       ...
       <div class="row" style="border-bottom:2px solid #bcbdc0; height:50px;" >
        <div style="width:17%; float:left; text-align: center;display:inline-table">  <?=$row['order_no']?>  </div>
    <div style="width:28%; float:left; text-align: center;display:inline-table"><?=$orderdate?></div>
    <div style="width:28%; float:left; text-align: center;display:inline-table"><?=$row['pick_up_date']?></div>
    <div style="width:27%; float:left; text-align: center; display:inline-table">$ <?=$row['total_amount']?></div>
