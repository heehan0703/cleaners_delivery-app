...
<form >
  ...
  <p style="color:#9F9E9A">Your Order is Being Processed</p>
     
  <div><img src="img/myorderpag.jpg"></div>
...
<div class="col-xs-6">
  <font color="#9F9E9A">
  <label for="radio8" ><font color="#9F9E9A">Pickup Date</font></label>
  </font></div>
  
<div class="col-xs-2">
 <span style="margin-left: 50%"><input type="button" value="+" onclick="incre()" /></span><br>
 <input type="text" value="<?php echo $date1 ?>"  id="wn" style="border:2px solid #00ACED; border-left: #FFF;  border-right: #FFF; padding: 1%;width:100%;color: #00ACED; "  name="dateday" /><br>
...
<div class="col-xs-2">
 ...
 <input type="text" value="<?php echo $date2 ?>" id="month" name="month"style="border:2px solid #00ACED; border-left: #FFF;  border-right: #FFF; padding: 1%; width:100%; color: #00ACED; "   /><br>
 <span style="margin-left: 50%"><input type="button" value="-" onClick="montdec()" /></span>
</div>
<div class="col-xs-2">
 <span style="margin-left: 50%"><input type="button" value="+" onclick="incre()" /></span><br>
 <input type="text" value="<?php echo $date3 ?>" id="date"  name="datenum"style="border:2px solid #00ACED; border-left: #FFF;  border-right: #FFF; padding: 1%; width:100% ;color: #00ACED;"  /><br>
 <span style="margin-left: 50%"><input type="button" value="-" onclick="decr()" /></span>
</div>
  </div>
